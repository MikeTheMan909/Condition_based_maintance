...
int main(void)
{
  ...
  while (1)
  {
	  switch(state){
	  	  ...
	  	  case 1:
	  		  SPSGRF_StartRx();
	  		  HAL_UART_Transmit(&huart1, (uint8_t *)"Starting RX state\n\r", sizeof("Starting RX state\n\r"), 1000);
	  		  state = 3;
	  		  break;
	  	  case 2:
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : SPI1_CS_Pin SPIRIT1_SDN_Pin */
  GPIO_InitStruct.Pin = SPI1_CS_Pin|SPIRIT1_SDN_Pin;
